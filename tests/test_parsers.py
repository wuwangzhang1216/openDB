...
def assert_valid_result(result: ParseResult):
...
class TestTextParser:
    ...
    def test_large_text_gets_chunked(self, tmp_path: Path):
...
class TestXlsxParser:
    ...
    def test_parse_basic(self, sample_xlsx: Path):
    ...
    def test_empty_sheet_handled(self, sample_xlsx: Path):
        mime = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        result = get_parser(mime).parse(sample_xlsx)
    ...
    def test_metadata_extraction(self, sample_xlsx: Path):
        mime = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
        result = get_parser(mime).parse(sample_xlsx)
